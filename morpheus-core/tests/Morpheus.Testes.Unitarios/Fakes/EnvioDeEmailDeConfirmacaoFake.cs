...
/// <summary>Guarda os envios de link de confirmação, para o teste conferir destino e token.</summary>
public sealed class EnvioDeEmailDeConfirmacaoFake : IEnvioDeEmailDeConfirmacao
{
