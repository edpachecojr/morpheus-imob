...
As diretrizes deste projeto vivem em um único lugar: **[CLAUDE.md](./CLAUDE.md)**.

Leia esse arquivo antes de escrever qualquer código. Ele é a fonte canônica de
regras de estilo, testes, dependências, estrutura, logging e tratamento de
segredos. Não duplique conteúdo aqui — alterações de convenção vão no CLAUDE.md.
